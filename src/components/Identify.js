function Identify(props){
    ...
    return (
        <div dir='ltr'>
            ...
            <button style={{position: 'absolute', right:'30%', borderRadius: 10, top:'100px'}} className="notEledrly" onClick={() => {props.history.push('/login')}}>I am not an elderly user</button>
        </div>
